...
### 🔴 用户必做（**明天 4/30 周四 09:00-10:00 JST**）

**🗓️ 2026 GW 日历**（已二次核对）：
- 4/28 周二 ✅ 交易日（OCO 触发当天）
- 4/29 周三 🔴 昭和の日（今天闭市）
- **4/30 周四 ✅ 交易日 ← 推荐建仓日**
- 5/1 周五 ✅ 交易日（也可，但建后立刻进长假）
- 5/2-5/3 周末（5/3 憲法記念日）
- 5/4 みどりの日 / 5/5 こどもの日 / 5/6 振替休日
- 5/7 周四 ✅ 长假后首个交易日

1. **4/30 周四 09:00-10:00 JST 在 SBI 建 ETF 仓位**：
   ```

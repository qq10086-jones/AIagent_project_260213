...
**Status: STEP 1 DONE (2026-08-13); steps 2-7 NOT STARTED.** `pyproject.toml` declared no runtime dependencies. The slow marker/lane already exists; this task completes and stabilizes it rather than inventing a new split.
...
- Generate and document a reproducible lock mechanism compatible with the supported Windows/Python environment. **(Step 2, not started.)**

...
function main() {
  ...
  const delegateFailure = buildDelegateFailureSummary({
    ...
    providerRequested: "opencode",
    providerUsed: "opencode",
    targetPaths: ["sandbox/crm_site/server.js"],
    finalGitSummary: {
      filesChanged: ["sandbox/crm_site/server.js"],
    ...
    staticCheck: { checked: true, ok: true, commands: ["node_syntax:sandbox/crm_site/server.js"], logPath: "artifacts/static_check.json" },
    verification: { checked: true, ok: false, command: "node --check sandbox/crm_site/server.js", logPath: "artifacts/verification.json" },
    adapterResult: {
      model_used: "qwen",
    ...
    verificationCommand: "node --check sandbox/crm_site/server.js",
